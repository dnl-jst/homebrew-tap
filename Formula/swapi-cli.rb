class SwapiCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/dnl-jst/swapi-cli/releases/download/v1.1.16/swapi-cli-macos"
      sha256 "e26eed7249052fee7d6fb62b877ce4ffce79fe08c0f3f978a96e8f7150c07941"
    else

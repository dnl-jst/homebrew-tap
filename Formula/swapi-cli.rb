class SwapiCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/dnl-jst/swapi-cli/releases/download/v1.2.1/swapi-cli-macos"
      sha256 "54df427255719550d570f1df8198aa65cd1fc52352bea1568fa7ecff62ae91c8"
    else

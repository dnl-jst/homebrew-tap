class SwapiCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/dnl-jst/swapi-cli/releases/download/v1.1.7/swapi-cli-macos"
      sha256 "1addbabeba7ecaf2d749da3947f6f7b9340159bdac79f0dfc71c713a9d3a6060"
    else

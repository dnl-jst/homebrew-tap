class SwapiCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/dnl-jst/swapi-cli/releases/download/v1.1.15/swapi-cli-macos"
      sha256 "857be6ae3feff5caa04538e359f9f30bca1d6107c28c451cd2765fb764f3edde"
    else

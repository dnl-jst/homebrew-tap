class SwapiCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/dnl-jst/swapi-cli/releases/download/v1.1.18/swapi-cli-macos"
      sha256 "1309b62b55ad83615bfd988dd04f910f5ed6f32c815fdd50e1f3f7a3169be2fd"
    else

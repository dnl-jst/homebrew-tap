class SwapiCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/dnl-jst/swapi-cli/releases/download/v1.1.4/swapi-cli-macos"
      sha256 "15705fcdb41a2406c8c719e3268689b8d9a6f8667b6c17f6ad44bdf95e94102a"
    else
